pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://98.82.167.31:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/srithars/fullstackapp.git', main: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://98.82.167.31:9090/springapp1"
            echo "✅ Frontend deployed: http://98.82.167.31:9090/frontapp1"
        }
        failure {
